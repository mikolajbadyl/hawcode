...
export function getUpdateInstruction(packageName: string): string {
	...
	switch (method) {
		case "bun-binary":
			return `Download from: https://github.com/mikolajbadyl/hawcode/releases/latest`;
		case "pnpm":
...
// =============================================================================
// App Config (from package.json hawcodeConfig)
// =============================================================================

const pkg = JSON.parse(readFileSync(getPackageJsonPath(), "utf-8"));

export const APP_NAME: string = "hawcode";
export const CONFIG_DIR_NAME: string = ".config/hawcode";
export const VERSION: string = pkg.version;

// e.g., HAWCODE_CODING_AGENT_DIR
...
/** Get path to tools.json (tool API keys and config) */
