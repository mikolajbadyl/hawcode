...
export interface Settings {
	...
	/** @deprecated Skills have been removed. This field is retained for settings file compatibility only. */
	skills?: string[];
	...
	lspEnabled?: boolean; // default: true - enable/disable LSP diagnostics
}
...
export class SettingsManager {
	...
	getClearOnShrink(): boolean {
		...
		return process.env.HAWCODE_CLEAR_ON_SHRINK === "1";
	}
	...
	getShowHardwareCursor(): boolean {
		return this.settings.showHardwareCursor ?? process.env.HAWCODE_HARDWARE_CURSOR === "1";
	}
	...
	getLspEnabled(): boolean {
		return this.settings.lspEnabled ?? true;
	}

	setLspEnabled(enabled: boolean): void {
		this.globalSettings.lspEnabled = enabled;
		this.markModified("lspEnabled");
		this.save();
	}
}
