 ...
 * Encodes cwd into a safe directory name under the sessions directory.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default sessions directory.
	 */
