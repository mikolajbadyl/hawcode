 ...
 * Defaults to "short" and uses HAWCODE_CACHE_RETENTION for backward compatibility.
 */
function resolveCacheRetention(cacheRetention?: CacheRetention): CacheRetention {
	if (cacheRetention) {
		return cacheRetention;
	}
	if (typeof process !== "undefined" && process.env.HAWCODE_CACHE_RETENTION === "long") {
		return "long";
	}
	return "short";
}
...
// To update: https://github.com/mikolajbadyl/hawcode
